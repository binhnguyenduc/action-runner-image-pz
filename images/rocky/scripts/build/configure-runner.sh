...
# Ensure coreutils/gzip are available even when PATH is stripped by sudo
...
install_runner() {
    ...
    sudo env PATH="/usr/bin:/bin:/usr/sbin:/sbin:$PATH" tar -xf /tmp/runner/_package/*.tar.gz -C /opt/runner-cache
}
